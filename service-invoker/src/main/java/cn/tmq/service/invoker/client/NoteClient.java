 ...
 *  这个接口调用的是登录功能的远程微服务
 *  注意 FeignClient(name = "service-provider-note")同一名称的微服务名称只能由一个接口声明，不能建立两个声明同样微服务名称的接口
 * @author 陶敏麒
 * @version 1.0
 */
@FeignClient(name = "service-provider-note",fallback = NoteClientFallback.class)
